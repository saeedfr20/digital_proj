# Generated by Django 5.2 on 2026-08-25 21:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cerated_time', models.DateTimeField(auto_now_add=True, verbose_name='created time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=50, verbose_name='title')),
                ('file_type', models.PositiveSmallIntegerField(choices=[(1, 'audio'), (2, 'video'), (3, 'fdf')], verbose_name='file type')),
